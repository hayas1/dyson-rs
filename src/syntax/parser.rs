...
impl<'a> Parser<'a> {
    ...
    //             Ok(found) => Err(ParserError::UnexpectedToken { expected, found, pos })?,
    //             Err(error) => Err(ParserError::TokenizeError::<JsonToken> { error, pos })?,
    //         }
    //     } else {
    //         let eof = lexer.json.eof();
    //         Err(ParserError::UnexpectedEof { expected, pos: eof })?
    //     }
    // }
    ...
    //     let &(pos, c) =
    //         lexer.peek().ok_or_else(|| ParserError::UnexpectedEof { expected: expected(), pos: lexer.json.eof() })?;
    ...
    //             }
    //         }
    //         Err(error) => Err(ParserError::TokenizeError::<ImmediateToken> { error, pos })?,
    //     }
    // }
    ...
    //         }
    //         Err(error) => Err(ParserError::TokenizeError::<EscapedStringToken> { error, pos: start })?,
    //     }
    // }
    ...
    //         }
    //         Err(error) => {
    //             Err(ParserError::TokenizeError::<NumberToken> { error, pos })?;
    //         }
    //     }
